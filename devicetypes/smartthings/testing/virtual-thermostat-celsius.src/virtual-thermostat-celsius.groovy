...
private initialize() {
    ...
    sendEvent(name: "schedule", value: Date.parse("yyyy-MM-dd'T'HH:mm:ss.SSS",dayTime).format("H:mm"))
    sendEvent(name: "speed", value: Date.parse("yyyy-MM-dd'T'HH:mm:ss.SSS",nightTime).format("H:mm"))
